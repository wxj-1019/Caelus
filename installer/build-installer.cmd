...
mkdir "release\Caelus-1.10.0-portable"
copy /y Caelus.exe "release\Caelus-1.10.0-portable\" >nul
copy /y Caelus.ico "release\Caelus-1.10.0-portable\" >nul
copy /y LICENSE "release\Caelus-1.10.0-portable\" >nul
copy /y README.md "release\Caelus-1.10.0-portable\" >nul
echo portable > "release\Caelus-1.10.0-portable\Caelus.portable"

rem create portable zip using PowerShell
echo [3/4] packaging portable ZIP...
powershell -NoProfile -Command "Compress-Archive -Path 'release\Caelus-1.10.0-portable\*' -DestinationPath 'release\Caelus-1.10.0-portable.zip' -Force"
if errorlevel 1 (
    echo Warning: PowerShell Compress-Archive failed, portable folder is still available
) else (
    echo Portable ZIP created: release\Caelus-1.10.0-portable.zip
)
echo.
...
if defined ISCC (
    ...
    if errorlevel 1 (
        ...
        echo Installer created: release\Caelus-1.10.0-Setup.exe
    )
) else (
